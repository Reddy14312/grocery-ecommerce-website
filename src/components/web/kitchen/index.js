...
export default class Kitchen extends Component {
  ...
  loadProducts = async () => {
    try {
      ...
      const products = await productService.getProductsByCategory('kitchen');
        ...
        <div id="myCarousel" className="carousel slide" data-ride="carousel">
          ...
          <div className="carousel-inner" role="listbox">
            <div className="item active">
              <Link to="/">
                <img className="first-slide" src="/images/ba.jpg" alt="First slide" />
              </Link>
            </div>
            <div className="item">
              <Link to="/">
                <img className="second-slide" src="/images/ba1.jpg" alt="Second slide" />
              </Link>
            </div>
            <div className="item">
              <Link to="/">
