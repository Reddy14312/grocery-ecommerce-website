...
export default class Household extends Component {
  ...
  loadProducts = async () => {
    try {
      ...
      const products = await productService.getProductsByCategory('household');
        ...
        <div id="myCarousel" className="carousel slide" data-ride="carousel">
          ...
          <div className="carousel-inner" role="listbox">
            <div className="item active">
              <Link to="/">
                <img className="first-slide" src="/images/ba2.jpg" alt="First slide" />
              </Link>
            </div>
            <div className="item">
              <Link to="/">
            ...
            <div className="item">
              <Link to="/">
                <img className="third-slide" src="/images/ba1.jpg" alt="Third slide" />
              </Link>
            </div>
          </div>
        </div>
